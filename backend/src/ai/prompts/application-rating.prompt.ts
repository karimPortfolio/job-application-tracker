...
{
  "candidateName": string, // the name of the candidate, if it can be inferred from the application text, otherwise return "Unknown"
  ...
  "decision": string // a recommendation of "Move Forward", "Maybe", or "Reject" based on the rating and overall impression of the application
}
