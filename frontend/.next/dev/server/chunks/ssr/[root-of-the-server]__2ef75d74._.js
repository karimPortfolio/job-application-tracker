...
const Silk = ({ speed = 5, scale = 1, color = '#7B7481', noiseIntensity = 1.5, rotation = 0 })=>{
    ...
    const uniforms = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>({
            ...
            uColor: {
                value: new Color(...hexToNormalizedRGB(color))
            },
            uRotation: {
                value: rotation
            },
...
(()=>{
    const e = new Error("Cannot find module '@/lib/api/axios'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/lib/api/sanctum.axios'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
const loginRequest = async (credentials)=>{
    return await api.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$routes$2f$auth$2e$routes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AUTH_ROUTES"].login, credentials);
};
const logoutRequest = async ()=>{
    return await api.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$routes$2f$auth$2e$routes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AUTH_ROUTES"].logout);
};
const fetchMe = async ()=>{
    const { data } = await api.get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$routes$2f$auth$2e$routes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["USER_ROUTES"].me);
    return data;
};
const registerRequest = async (credentials)=>{
    const { data } = await api.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$routes$2f$auth$2e$routes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AUTH_ROUTES"].register, credentials);
    return data;
};
const forgotPasswordRequest = async (credentials)=>{
    const { email } = credentials;
    await api.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$routes$2f$auth$2e$routes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AUTH_ROUTES"].forgotPassword, {
        email
    });
};
const resetPasswordRequest = async (credentials)=>{
    const { email, token, password, password_confirmation } = credentials;
    await api.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$routes$2f$auth$2e$routes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AUTH_ROUTES"].resetPassword, {
        email,
        token,
        password,
...
const emailVerficationRequest = async ()=>{
    await api.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$routes$2f$auth$2e$routes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AUTH_ROUTES"].verifyEmail);
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2ef75d74._.js.map