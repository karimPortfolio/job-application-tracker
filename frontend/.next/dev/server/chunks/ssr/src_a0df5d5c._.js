...
"[project]/src/features/dashboard/routes/dashboard-monthly-stats.routes.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$monthly$2d$stats$2e$routes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/routes/dashboard-monthly-stats.routes.ts [app-ssr] (ecmascript)");
;
;
;
...
const getDepartmentsMonthlyStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$monthly$2d$stats$2e$routes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DASHBOARD_MONTHLY_STATS_ROUTES"].getDepartmentsMonthlyStats);
};
const getJobsMonthlyStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$monthly$2d$stats$2e$routes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DASHBOARD_MONTHLY_STATS_ROUTES"].getJobsMonthlyStats);
};
const getApplicationsMonthlyStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$monthly$2d$stats$2e$routes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DASHBOARD_MONTHLY_STATS_ROUTES"].getApplicationsMonthlyStats);
};
}),
"[project]/src/features/dashboard/hooks/useDashboardMonthlyStats.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function useDashboardMonthlyStats() {
    ...
    const [departmentsMonthlyStats, setDepartmentsMonthlyStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [jobsMonthlyStats, setJobsMonthlyStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    async function fetchDepartmentsMonthlyStats() {
        clearError();
        try {
            const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDepartmentsMonthlyStats"])();
            setDepartmentsMonthlyStats(data);
        } catch (err) {
            handleError(err);
        }
    }
    async function fetchJobsMonthlyStats() {
        clearError();
        try {
            const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getJobsMonthlyStats"])();
            setJobsMonthlyStats(data);
        } catch (err) {
            handleError(err);
        }
    }
    async function fetchApplicationsMonthlyStats() {
        clearError();
        try {
            const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getApplicationsMonthlyStats"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        setLoading(true);
        Promise.all([
            fetchDepartmentsMonthlyStats(),
            fetchJobsMonthlyStats(),
            fetchApplicationsMonthlyStats()
        ]).finally(()=>setLoading(false));
    }, []);
    return {
        departmentsMonthlyStats,
        jobsMonthlyStats,
...
"[project]/src/features/dashboard/components/MonthlyStatsChartsCards.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useDashboardMonthlyStats$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/hooks/useDashboardMonthlyStats.ts [app-ssr] (ecmascript)");
...
function MonthlyStatsChartsCards() {
    const { applicationsMonthlyStats, departmentsMonthlyStats, jobsMonthlyStats, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useDashboardMonthlyStats$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useDashboardMonthlyStats"])();
    const chartConfig1 = {
        applications: {
            label: "Applications",
            color: "#2563eb"
        ...
        return [
            {
                ...
                stats: applicationsMonthlyStats,
                chartConfig: chartConfig1
            },
            {
                label: "Monthly Jobs",
                stats: jobsMonthlyStats,
                chartConfig: chartConfig2
            },
            {
                label: "Monthly Departments",
                stats: departmentsMonthlyStats,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$components$2f$MonthlyStatsChartsCards$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/components/MonthlyStatsChartsCards.tsx [app-ssr] (ecmascript)");
...
function DashboardClient() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$components$2f$MonthlyStatsChartsCards$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MonthlyStatsChartsCards"], {}, void 0, false, {
                fileName: "[project]/src/app/(protected)/dashboard/DashboardClient.tsx",
                lineNumber: 11,
                columnNumber: 7
            }, this)
...
//# sourceMappingURL=src_a0df5d5c._.js.map