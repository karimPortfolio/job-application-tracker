...
"[project]/src/features/dashboard/routes/dashboard-yearly-stats.routes.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$yearly$2d$stats$2e$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/routes/dashboard-yearly-stats.routes.ts [app-client] (ecmascript)");
;
;
;
...
const getDepartmentsYearlyStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$yearly$2d$stats$2e$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DASHBOARD_YEARLY_STATS_ROUTES"].getDepartmentsYearlyStats);
};
const getJobsYearlyStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$yearly$2d$stats$2e$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DASHBOARD_YEARLY_STATS_ROUTES"].getJobsYearlyStats);
};
const getApplicationsYearlyStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$yearly$2d$stats$2e$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DASHBOARD_YEARLY_STATS_ROUTES"].getApplicationsYearlyStats);
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
"[project]/src/features/dashboard/hooks/useDashboardYearlyStats.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useDashboardYearlyStats() {
    _s();
    const { handleError, error, clearError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useApiError$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApiError"])();
    const [departmentsYearlyStats, setDepartmentsYearlyStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [jobsYearlyStats, setJobsYearlyStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [applicationsYearlyStats, setApplicationsYearlyStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    async function fetchDepartmentsYearlyStats() {
        clearError();
        try {
            const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDepartmentsYearlyStats"])();
    ...
    async function fetchJobsYearlyStats() {
        clearError();
        try {
            const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getJobsYearlyStats"])();
    ...
    async function fetchApplicationsYearlyStats() {
        clearError();
        try {
            const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApplicationsYearlyStats"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDashboardYearlyStats.useEffect": ()=>{
            setLoading(true);
            Promise.all([
                ...
                "useDashboardYearlyStats.useEffect": ()=>setLoading(false)
            }["useDashboardYearlyStats.useEffect"]);
        }
    }["useDashboardYearlyStats.useEffect"], []);
    return {
...
_s(useDashboardYearlyStats, "70MrVrom0cihqMbM0w1TMJ/eiZU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useApiError$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApiError"]
    ];
});
...
"[project]/src/features/dashboard/components/YearlyStatsChartsCards.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/card.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/skeleton.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useDashboardYearlyStats$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/hooks/useDashboardYearlyStats.ts [app-client] (ecmascript)");
...
function YearlyStatsChartsCards() {
    _s();
    const { applicationsYearlyStats, departmentsYearlyStats, jobsYearlyStats, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useDashboardYearlyStats$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboardYearlyStats"])();
    const chartConfig1 = {
        applications: {
            label: "Applications",
            color: "#2563eb"
    ...
    const data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "YearlyStatsChartsCards.useMemo[data]": ()=>{
            if (loading) [];
            return [
                {
    ...
    const yearsOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "YearlyStatsChartsCards.useMemo[yearsOptions]": ()=>{
            const currentYear = new Date().getFullYear();
            return Array.from({
                length: 10
            }, {
                "YearlyStatsChartsCards.useMemo[yearsOptions]": (_, i)=>({
...
_s(YearlyStatsChartsCards, "4CC+2rMZL9l0y+7d8U27xTQBxlA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useDashboardYearlyStats$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboardYearlyStats"]
    ];
});
_c = YearlyStatsChartsCards;
var _c;
__turbopack_context__.k.register(_c, "YearlyStatsChartsCards");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$components$2f$YearlyStatsChartsCards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/components/YearlyStatsChartsCards.tsx [app-client] (ecmascript)");
"use client";
;
;
;
function DashboardClient() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$components$2f$YearlyStatsChartsCards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["YearlyStatsChartsCards"], {}, void 0, false, {
                fileName: "[project]/src/app/(protected)/dashboard/DashboardClient.tsx",
                lineNumber: 11,
                columnNumber: 7
            }, this)
...
//# sourceMappingURL=src_f62e7147._.js.map