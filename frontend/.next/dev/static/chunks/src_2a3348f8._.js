...
function useDepartmentActions() {
    ...
    const { refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$departments$2f$hooks$2f$useDepartmentsList$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDepartmentsList"])();
    ...
    const findDepartment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDepartmentActions.useCallback[findDepartment]": async (id)=>{
            setLoading(true);
            try {
    ...
    }["useDepartmentActions.useCallback[findDepartment]"], [
        handleError
    ]);
    const create = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDepartmentActions.useCallback[create]": async (payload)=>{
            setLoading(true);
            try {
    ...
    }["useDepartmentActions.useCallback[create]"], [
        handleError
    ]);
    const update = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDepartmentActions.useCallback[update]": async (id, payload)=>{
            setLoading(true);
            try {
    ...
    }["useDepartmentActions.useCallback[update]"], [
        handleError
    ]);
    const destroy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDepartmentActions.useCallback[destroy]": async (id)=>{
            setLoading(true);
            try {
    ...
    }["useDepartmentActions.useCallback[destroy]"], [
        handleError
    ]);
    const confirmDelete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDepartmentActions.useCallback[confirmDelete]": async (department)=>{
    ...
    }["useDepartmentActions.useCallback[confirmDelete]"], [
        confirm,
        destroy
    ]);
    return {
...
_s(useDepartmentActions, "8pSSuuSM7tELMlup/iVKYCz89Qk=", false, function() {
    return [
...
function CreateDepartmentFormDialog({ onSuccess, open = false, setOpen }) {
    _s();
    const { create, loading, apiError, clearApiError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$departments$2f$hooks$2f$useDepartmentActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDepartmentActions"])();
...
_s(CreateDepartmentFormDialog, "qo/Flqyut7qq2lZye2cy5h/NXhU=", false, function() {
    return [
...
_s(DepartmentsTable, "hvNwUdjMfxClvOP9Jz0UJPYIzIY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$departments$2f$hooks$2f$useDepartmentsList$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDepartmentsList"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$departments$2f$hooks$2f$useDepartmentActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDepartmentActions"],
...
function UpdateDepartmentFormDialog({ onSuccess, open = false, setOpen, id }) {
    _s();
    const { update, loading, apiError, findDepartment, clearApiError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$departments$2f$hooks$2f$useDepartmentActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDepartmentActions"])();
    const resolver = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
...
_s(UpdateDepartmentFormDialog, "NtfG5b/s3MCF5cK9Vc5k+PIrof0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$departments$2f$hooks$2f$useDepartmentActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDepartmentActions"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"]
    ];
...
//# sourceMappingURL=src_2a3348f8._.js.map