...
;
;
const resolver = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$hookform$2f$resolvers$2f$zod$2f$dist$2f$zod$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["zodResolver"])();
...
;
;
function JobsTable({ onEdit, onChangeStatus }) {
    _s();
    ...
    const { confirmDelete, loading: isDeleting, refetchJobsDepartments } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$jobs$2f$hooks$2f$useJobsActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useJobActions"])({
        "JobsTable.useJobActions": async ()=>{
            await refetch();
        }
    }["JobsTable.useJobActions"]);
...
_s(JobsTable, "pEf0PxATZpr28XndAtxGkPQ2Rm8=", false, function() {
    return [
...
_s(JobsClient, "l2nix090j4DZWv98dVQbE91+YmQ=", false, function() {
    return [
...
//# sourceMappingURL=src_191e1bd5._.js.map