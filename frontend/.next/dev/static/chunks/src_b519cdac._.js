...
"[project]/src/features/dashboard/routes/dashboard-total.routes.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$total$2e$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/routes/dashboard-total.routes.ts [app-client] (ecmascript)");
;
;
const getDepartmentsTotalStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$total$2e$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DASHBOARD_TOTAL_ROUTES"].getDepartmentsTotalStats);
};
const getJobsTotalStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$total$2e$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DASHBOARD_TOTAL_ROUTES"].getJobsTotalStats);
};
const getApplicationsTotalStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$total$2e$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DASHBOARD_TOTAL_ROUTES"].getApplicationsTotalStats);
};
const getDepartmentsMonthlyStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$total$2e$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DASHBOARD_TOTAL_ROUTES"].getDepartmentsMonthlyStats);
};
const getJobsMonthlyStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$total$2e$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DASHBOARD_TOTAL_ROUTES"].getJobsMonthlyStats);
};
const getApplicationsMonthlyStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$routes$2f$dashboard$2d$total$2e$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DASHBOARD_TOTAL_ROUTES"].getApplicationsMonthlyStats);
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/features/dashboard/hooks/useDashboardMonthlyStats.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useDashboardMonthlyStats() {
    ...
    const [departmentsMonthlyStats, setDepartmentsMonthlyStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [jobsMonthlyStats, setJobsMonthlyStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    async function fetchDepartmentsMonthlyStats() {
        clearError();
        try {
            const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDepartmentsMonthlyStats"])();
    ...
    async function fetchJobsMonthlyStats() {
        clearError();
        try {
            const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getJobsMonthlyStats"])();
    ...
    async function fetchApplicationsMonthlyStats() {
        clearError();
        try {
            const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$services$2f$dashboard$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApplicationsMonthlyStats"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDashboardMonthlyStats.useEffect": ()=>{
            setLoading(true);
            Promise.all([
                ...
                "useDashboardMonthlyStats.useEffect": ()=>setLoading(false)
            }["useDashboardMonthlyStats.useEffect"]);
        }
    }["useDashboardMonthlyStats.useEffect"], []);
    return {
...
_s(useDashboardMonthlyStats, "UeEhBipPyiEL40WoY0TfOcKPqLY=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useDashboardMonthlyStats$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/dashboard/hooks/useDashboardMonthlyStats.ts [app-client] (ecmascript)");
...
function MonthlyStatsChartsCards() {
    _s();
    const { applicationsMonthlyStats, departmentsMonthlyStats, jobsMonthlyStats, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useDashboardMonthlyStats$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboardMonthlyStats"])();
    const chartConfig1 = {
        applications: {
            label: "Applications",
            color: "#2563eb"
    ...
    const data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MonthlyStatsChartsCards.useMemo[data]": ()=>{
            if (loading) [];
            return [
                {
...
_s(MonthlyStatsChartsCards, "fJmUS8GRDkke2jvyBe18iercI+k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$dashboard$2f$hooks$2f$useDashboardMonthlyStats$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDashboardMonthlyStats"]
    ];
});
...
//# sourceMappingURL=src_b519cdac._.js.map