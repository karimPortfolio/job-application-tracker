...
;
;
function JobsTable({ onEdit, onChangeStatus, onRefetchChange }) {
    _s();
    ...
    const onDeleteSuccess = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "JobsTable.useCallback[onDeleteSuccess]": async ()=>{
            await refetch();
        }
    }["JobsTable.useCallback[onDeleteSuccess]"], [
        refetch
    ]);
    const { confirmDelete, loading: isDeleting, refetchJobsDepartments } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$jobs$2f$hooks$2f$useJobsActions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useJobActions"])(onDeleteSuccess);
    ...
    // Expose refetch to parent when it changes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JobsTable.useEffect": ()=>{
...
_s(JobsTable, "280GCF+Tgd/wQP3z2utAHQ7AW7A=", false, function() {
    return [
...
_s(JobsClient, "vRELQjPiN/cxJYZYn66UKvoTyZE=", false, function() {
    return [
...
//# sourceMappingURL=src_36a88bca._.js.map