...
(()=>{
    const e = new Error("Cannot find module '../hooks/useDashboardYearlyStats'");
...
function YearlyStatsChartsCards() {
    _s();
    const { applicationsYearlyStats, departmentsYearlyStats, jobsYearlyStats, loading } = useDashboardYearlyStats();
    const chartConfig1 = {
        applications: {
            label: "Applications",
            color: "#2563eb"
...
//# sourceMappingURL=src_5d805a6e._.js.map