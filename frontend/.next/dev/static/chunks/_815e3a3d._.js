...
(()=>{
    const e = new Error("Cannot find module '../routes/dashboard-total.routes'");
...
const getDepartmentsTotalStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(DASHBOARD_TOTAL_ROUTES.getDepartmentsTotalStats);
};
const getJobsTotalStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(DASHBOARD_TOTAL_ROUTES.getJobsTotalStats);
};
const getApplicationsTotalStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(DASHBOARD_TOTAL_ROUTES.getApplicationsTotalStats);
};
const getDepartmentsMonthlyStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(DASHBOARD_TOTAL_ROUTES.getDepartmentsMonthlyStats);
};
const getJobsMonthlyStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(DASHBOARD_TOTAL_ROUTES.getJobsMonthlyStats);
};
const getApplicationsMonthlyStats = ()=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(DASHBOARD_TOTAL_ROUTES.getApplicationsMonthlyStats);
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
//# sourceMappingURL=_815e3a3d._.js.map