...
(()=>{
    const e = new Error("Cannot find module '../hooks/useDashboardMonthlyStats'");
...
function MonthlyStatsChartsCards() {
    _s();
    const { applicationsMonthlyStats, departmentsMonthlyStats, jobsMonthlyStats, loading } = useDashboardMonthlyStats();
    const chartConfig1 = {
        applications: {
            label: "Applications",
            color: "#2563eb"
...
_s(useDashboardStats, "WU+eBJMec6+hRft6mDHfrqJPd5w=", false, function() {
    return [
...
//# sourceMappingURL=src_a62ba4b4._.js.map