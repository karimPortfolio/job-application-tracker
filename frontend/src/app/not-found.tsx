        ...
        <div className="w-full overflow-hidden rounded-2xl border border-white/60 bg-white/90 p-8 shadow-[0_25px_70px_-25px_rgba(15,23,42,0.35)] backdrop-blur-xl dark:border-white/10 dark:bg-white/5">
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            <div className="space-y-4 md:max-w-xl">
              <p className="text-lg font-semibold uppercase tracking-[0.2em] text-slate-600 dark:text-slate-200">
                404
              </p>
              ...
              <p className="text-base leading-relaxed text-slate-600 dark:text-slate-300">
                The link may be broken or the page might have moved. Use the
                quick links below to get back on track.
              </p>
